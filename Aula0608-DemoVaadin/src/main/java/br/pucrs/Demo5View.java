...
@PageTitle("Demo 5 - Cadastro de pessoas - Eliminação")
@Route("demo5")
public class Demo5View extends VerticalLayout {
    ...
    public Demo5View() {
        ...
        grid.addComponentColumn(pessoa -> {
            ...
            deleteButton.addClickListener(clickEvent -> {
                // 2. Remova o item da lista que alimenta o grid e atualize
                cadPessoas.eliminar(pessoa);

                Notification.show("Pessoa excluída: " + pessoa.getNome());
                // Após a eliminação, recarrega a lista
                grid.setItems(cadPessoas.getLista());
            });
